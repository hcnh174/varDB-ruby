...
function createLinearGradient()
{
	...
	/*
	<linearGradient id="dnasequence" x1="50%" y1="0%" x2="50%" y2="100%">
...
function createRadialGradient(color)
{
	...
	//example: “r#fff-#000” – gradient from white to black 
	//or “r(0.25, 0.75)#fff-#000” – gradient from white to black with focus point at 0.25, 0.75
	/*
	<radialGradient id="domain-Duffy_binding" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
