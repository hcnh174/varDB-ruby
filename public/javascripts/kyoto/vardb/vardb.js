/*global Ext, kyoto, utils, alert, VardbDirect */
(kyoto.vardb.Vardb=function()
{	
	...
	getTerm:function(identifier)
	{
		...
		{
			var popup=new kyoto.vardb.popups.TermPopup({term: response.result});
	    });
	}
};}());

var vardb=kyoto.vardb.Vardb;
