/*global Ext, vardb */
Ext.ux.vardb.explorer.Toolbar = Ext.extend(Ext.Toolbar,
{
	height: 25,
	...
	initComponent:function()
	{
		...
		var searchmenu=
		{
			...
			{
				var dialog=new Ext.ux.vardb.quickcart.QuickSearch({});
		...
		var batchlookupmenu=
		{
			...
			handler: function(btn)
			{
				var dialog=new Ext.ux.vardb.explorer.BatchLookupDialog(function(cart)
				{
		...
		var usersequencesmenu=
		{
			...
			handler: function(btn)
			{
				var dialog=new Ext.ux.vardb.UploadSequencesDialog(
				{
