...
(nelson.tags.Tags=function(){	return {
	...
	{
		var dialog=new Ext.ux.vardb.tags.NamePromptDialog({type: 'bundle', callback: function(name)
		{
	...
	editTag:function(tag_id)
	{
		...
		{
			var dialog=new Ext.ux.vardb.tags.EditTagDialog({tag: tag});
		});
	},
	...
	showBundle:function(bundle_id)
	{
		...
		{
			var dialog=new Ext.ux.vardb.tags.BundleDialog({bundle: bundle});
		});
	},
	...
	joinByBundle:function(bundle_id)
	{
		...
		{
			var dialog=new Ext.ux.vardb.tags.JoinDialog({bundles: bundles});
		});
	},
	...
	createTagCloudFromFilter:function(filter)
	{
		...
		{
			var dialog=new Ext.ux.vardb.tags.TagCloud({tagcloud: tagcloud});
		});
	},
